"""Betr Picks prop provider.

Configure one of EDGEIQ_BETR_PROPS_URL or EDGEIQ_BETR_PROPS_FILE.
If an API requires auth, set EDGEIQ_BETR_API_KEY.
"""
...
def fetch_projections() -> list[dict]:
    return fetch_configured_props("Betr", "BETR")
