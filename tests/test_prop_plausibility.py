...
def test_accepts_normal_and_broad_alternate_markets():
    ...
    assert prop_line_plausibility({"sport": "NCAAF", "stat": "Passing Yards", "line": 325.5}).valid
    assert not prop_line_plausibility({"sport": "NCAAF", "stat": "Passing Yards", "line": 900.5}).valid
