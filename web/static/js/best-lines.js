(function () {
  ...
  async function search(event) {
    ...
    try {
      result.innerHTML = render(await window.EdgeIQApi.api(`/api/market/best-lines?${params}`, {timeoutMs: 20000}));
    } catch (error) {
  ...
  window.EdgeIQBestLines = { search, render };
}());
